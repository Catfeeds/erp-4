...
class StockChange extends Model
{
    ...
    protected $table = 'manufacture_stock_changes';
    ...
    public function getViewCollect() {
        return '<a href="/admin/manufacture/collects/'.$this->id.'" class="btn btn-xs btn-info"><i class="fa fa-eye" data-toggle="tooltip" data-placement="top" title="查看"></i></a> ';
    }
    ...
    public function getViewRetour() {
        return '<a href="/admin/manufacture/retours/'.$this->id.'" class="btn btn-xs btn-info"><i class="fa fa-eye" data-toggle="tooltip" data-placement="top" title="查看"></i></a> ';
    }
    public function getEditRetourt() {

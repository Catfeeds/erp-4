...
class AuthController extends Controller
{
    ...
    public function postRegister(RegisterRequest $request)
    {
        if (config('access.users.confirm_email')) {
            ...
            return redirect()->route('home')->withFlashSuccess("您的帐户已成功创建。我们已经向您发出了一封电子邮件，以确认您的帐户。");
        } else {
    ...
    public function confirmAccount($token)
    {
        ...
        try {
            ...
            return redirect()->route('frontend.dashboard')->withFlashSuccess("您的帐户已成功确认！");
        } catch (GeneralException $e) {
            return redirect()->back()->withInput()->withFlashDanger($e->getMessage());
        }
    }
    ...
    public function resendConfirmationEmail($user_id)
    {
        ...
        try {
            ...
            return redirect()->route('home')->withFlashSuccess("一个新的确认电子邮件已经发送到您的邮箱。");
        } catch (GeneralException $e) {
            return redirect()->back()->withInput()->withFlashDanger($e->getMessage());
        }
    }

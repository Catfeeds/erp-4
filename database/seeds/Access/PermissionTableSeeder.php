...
class PermissionTableSeeder extends Seeder {
	...
	public function run() {
		...
		$changeUserPassword->display_name = '更改用户密码';
		...
		$deactivateUser->display_name = '停用用户';
		...
		$reactivateUser->display_name = '重新激活用户';
		...
		$resendConfirmationEmail->display_name = '重发确认邮件';

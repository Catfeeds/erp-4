...
@section('page-header')
    <h1>
        ...
        <a class="btn btn-warning btn-xs" href="/admin/personnel/personnels"><b>返 回</b></a>
    </h1>
@endsection
...
<div class="box box-warning">
  <div class="box-body">
  <?php
    $form = ['url' => URL('/admin/personnel/personnels/'.$personnel->id ),
        '_method' => 'PATCH',
        'method' => 'POST',
        'defaults' => [
          'name'      => $personnel->name, 
  ...
  <div class="well">
    <div class="pull-left">
        <a href="/admin/personnel/personnels" class="btn btn-danger btn-xs">{{ trans('strings.cancel_button') }}</a>
    </div>

...
@section('content')
    ...
    {!! Form::open(['route' => 'admin.access.roles.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-role']) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                {!! Form::select('associated-permissions', array('all' => '所有权限', 'custom' => '自定义'), 'all', ['class' => 'form-control']); !!}

                <div id="available-permissions" class="hidden">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="alert alert-info">
                                <i class="fa fa-info-circle"></i> 标有<small><STRONG>（D）的一个授权</ STRONG></small>意味着许可具有依赖性。他们会自动当您选择该权限进行检查。您可以在编辑权限屏幕的相关标签管理每个权限的依赖。
                            </div><!--alert-->
                        </div><!--col-lg-12-->

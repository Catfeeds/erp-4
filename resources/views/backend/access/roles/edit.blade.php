        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                @if ($role->id != 1)
                    ...
                    {!! Form::select('associated-permissions', array('all' => '所有权限', 'custom' => '自定义'), $role->all ? 'all' : 'custom', ['class' => 'form-control']); !!}
                @else
                    <span class="label label-success">所有权限</span>
                @endif
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="alert alert-info">
                                <i class="fa fa-info-circle"></i> 标有<small><strong>（D）的一个授权</strong></small>意味着许可具有依赖性。他们会自动在您选择该权限进行检查。您可以在编辑权限界面的相关标签管理每个权限的依赖。
                            </div><!--alert-->
                        </div><!--col-lg-12-->

                        <div class="col-lg-6">
                            <p><strong>分组权限</strong></p>

            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane" id="dependencies" style="padding-top:20px">
                    ...
                    <div class="alert alert-info">
                        <i class="fa fa-info-circle"></i>权限依赖允许你告诉系统某个权限基于一个或多个其它权限。<br/><br/>
                        例如：如果用户有<strong>创建用户</strong>权限，那么还要具备<strong>查看后台</strong>和<strong>查看访问管理</ STRONG>的权限，否则他们不能到达<strong>创建用户</strong>界面。
                    </div><!--alert-->

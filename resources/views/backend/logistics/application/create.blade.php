...
<div class="box box-danger">
  <div class="box-body">
    <?php
    $form = ['url' => '/admin/logistics/applications',
        'method' => 'POST',
        'defaults' => [
          'number' => $number, 
          'product_id' => '', 
    ...
    ?>
    @include('backend.logistics.application.form')
  </div>
</div><div id="myModal" class="modal fade bs-example-modal-lg">

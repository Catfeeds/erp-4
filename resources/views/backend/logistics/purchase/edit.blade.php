...
@section('page-header')
    <h1>
        编辑其它入库
        <small>编辑其它入库明细</small>
        <a class="btn btn-danger btn-xs " href="/admin/logistics/imports"><b>返 回</b></a>
    </h1>
@endsection
...
<div class="box box-warning">
  <div class="box-body">
  <?php
    $form = ['url' => URL('/admin/logistics/imports/'.$import->id ),
        '_method'  => 'PATCH',
        'method'   => 'POST',
        'defaults' => [
    ...
    ?>
    @include('backend.logistics.import.form')  
  </div>
</div>

...
<div class="box box-danger">
  <div class="box-body">
    ...
    ?>
    @include('backend.logistics.purchase.form')
  </div>
</div>
...
$(function () {      
  ...
  $('#submit_modal').click(function(){
    ...
    for( var x in datas){
      oldDatas.push(datas[x]);
    };
    for( var x=0 in oldDatas){
      if(!isNaN(oldDatas[x].quantity)){
        oldDatas[x].amount = oldDatas[x].quantity;
      }
      oldDatas[x].No = parseInt(x) + 1;
      oldDatas[x].quantity ='<input hidden type="text" name="products['+x+'][appDetailId]" value="'+oldDatas[x].appDetailId+'"/><input hidden type="text" name="products['+x+'][product_id]" value="'+oldDatas[x].id+'"/><input type="text" class="quantity" name="products['+x+'][quantity]" value="'+oldDatas[x].amount+'"/>';
      if (x == 0) {
        $('textarea').html(oldDatas[x].name+'...');
      };
    };
    $('#tb_A').bootstrapTable('load',oldDatas);
...
var products_app = <?php echo $products_app ?>;
var products_plan = <?php echo $products_plan ?>;
var products = <?php echo $products ?>;
var json_apps = <?php echo $json_apps ?>;        
var json_plans = <?php echo $json_plans ?>;
var json_products = <?php echo $json_products ?>;

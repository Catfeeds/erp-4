...
@section('page-header')
    <h1>
         其它出库
        <small>其它出库详细信息</small>
        <a class="btn btn-info btn-xs" href="/admin/logistics/exports"><b>返 回</b></a>
    </h1>
@endsection

@section('breadcrumbs')
    @include('backend.includes.breadcrumbs.logistics')
    <li class="active">其它出库信息</li>
@endsection

...
@section('page-header')
    <h1>
        编辑其它出库
        <small>编辑其它出库明细</small>
        <a class="btn btn-danger btn-xs " href="/admin/logistics/exports"><b>返 回</b></a>
    </h1>
@endsection
...
<div class="box box-warning">
  <div class="box-body">
  <?php
    $form = ['url' => URL('/admin/logistics/exports/'.$export->id ),
        '_method'  => 'PATCH',
        'method'   => 'POST',
        'defaults' => [
          ...
          'remark'      => $export->remark,
    ], ];
    ?>
    @include('backend.logistics.export.form')  
  </div>
</div>

...
@section('page-header')
    <h1>
        其它入库
        <small>其它入库信息</small>
        <a class="btn btn-success btn-xs" href="{{ URL('admin/logistics/imports/create') }}"><b>新 建</b></a>
    </h1>
@endsection

@section('breadcrumbs')
    @include('backend.includes.breadcrumbs.logistics')
    <li class="active">其它入库</li>
@endsection
...
<div class="box box-success">
  <div class="box-body">
    <table class=" table table-bordered table-hover" >
      ...
      <tbody>
        @foreach ($imports as $key=>$content)
        <tr>
    ...
    <div class="pull-left">
        总数: {!! $imports->total() !!}
        {!! Session::flash('currentPage', $imports->currentPage()); !!}
    </div>

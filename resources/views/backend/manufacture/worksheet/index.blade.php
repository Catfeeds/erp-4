...
@section('page-header')
    <h1>
        加工单
        <small>加工单列表</small>
        <a class="btn btn-success btn-xs " href="/admin/manufacture/worksheets/create"><b>新 建</b></a>
    </h1>
@endsection

@section('breadcrumbs')
    @include('backend.includes.breadcrumbs.manufacture')
    <li class="active">加工单</li>
@endsection
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
                <select class="form-control" name="state_id" class="select">
                    <option value="18" type="text">未完成</option>
                    <option value="19" type="text">已完成</option>
                    <option value="20" type="text">中止</option>
                </select>
              </div>
            </div>
          </div>

...
<div>
  <ul id="myTab" class="nav nav-tabs">
     <li class="active"><a href="#A" data-toggle="tab">需求-树</a></li>
     <li><a href="#B" data-toggle="tab">需求-表</a></li>
    ...
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane fade in active" id="A">
        <div class="tree">
          <ul>
            <li>
            <span ><i class="glyphicon glyphicon-minus"></i> {{ $product->name }}---<span class="badge">需求：{{ $product->need }} </span> </span> <i class="badge ">库存：{{ $product->total }}</i>
              <ul>
                @foreach($needTree as $content)
                  @if(isset($content['son']))
                    <li>
                      <span><i class="glyphicon glyphicon-minus"></i>{{ $content->children->name }}---<span class="badge">需求：{{ $content->need }}</span></span> <i class="badge {{ $content->total < $content->need ? 'bg-red':'bg-green'}}">库存：{{ $content->total }}</i>
                      <ul>
                                                  ...
                                                  @if(isset($content['son']))
                                                    <li>
                                                      ...
                                                      @foreach($content['son'] as $content)
                                                        @if(isset($content['son']))
                                                          <li>
                                                            <span><i class="glyphicon glyphicon-minus"></i>{{ $content->children->name }}</span>---<span class="badge">需求：{{ $content->need }}</span></span> <i class="badge {{ $content->total < $content->need ? 'bg-red':'bg-green'}}">库存：{{ $content->total }}</i>
                                                            <ul>
                                                            @foreach($content['son'] as $content)
                                                              @if(isset($content['son']))
                                                                <li>
                                                                    ...
                                                                    @if(isset($content['son']))
                                                                      <li>
                                                                        ...
                                                                        @foreach($content['son'] as $content)
                                                                          ...
                                                                          @else
                                                                            <li>
                                                                              <span><i class="glyphicon glyphicon-leaf"></i>{{ $content->children->name }}---<span class="badge">需求：{{ $content->need }}</span></span> <i class="badge {{ $content->total < $content->need ? 'bg-red':'bg-green'}}">库存：{{ $content->total }}</i>
                                                                            </li>
                                                                          @endif
                                                                        @endforeach 
                                                                        </ul>
          ...
          <tbody>
            ...
            @foreach ($needTree as $content)
              <tr>
                ...
                <td class="hidden-xs">{{ $content->total }}</td>
      ...
      <div class="tab-pane fade in " id="C">
        <table class=" table table-bordered table-hover " >
          ...
          <tbody>
            <p hidden>{{ $i = 1 }}</p>
            @foreach ($needTree as $content)
              @if($content->total < $content->need && $content->children->type_id == 37)
              <tr>
                <td>{{ $i++ }}</td>
                <td class="hidden-xs">{{ $content->children->number }}</td>
                <td>{{ $content->children->name }}</td>

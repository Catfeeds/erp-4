...
@section('page-header')
    <h1>
        生产计划
        <small>生产计划列表</small>
        <a class="btn btn-success btn-xs " href="/admin/manufacture/plans/create"><b>新 建</b></a>
    </h1>
@endsection
...
<script type="text/javascript">
    $(function () {       
        ...
        $('.model').click(function(){
            ...
            $modal.find(".form-group").html('<label name="name" class="control-label col-md-2">状态</label><div class="col-md-8"><select class="form-control" name="state_id" class="select"><option value="90" type="text">未完成</option><option value="91" type="text">已完成</option><option value="92" type="text">中止</option></select></div>');
            $modal.modal();   
        ...
        $('a.mrp').click(function(){
          var product_row = $(this).parent().parent();
          var number = product_row.find('b.plan_number').html();
          var quantity = product_row.find('.quantity').html();
          window.location.href="/admin/manufacture/planMrp/"+number+'/'+quantity;
        });
    ...
    oTableInit.InitSubTable = function (index, row, $detail) {
        ...
        $(cur_table).bootstrapTable({
            url: '/admin/manufacture/planJson',
            method: 'get',         

...
@section('after-styles-end')
	<link rel="stylesheet" type="text/css" href="/calendar/bootstrap-3.3.5/css/bootstrap.min.css" />
	<!-- <link rel="stylesheet" type="text/css" href="/calendar/css/default.css"> -->
	<link rel="stylesheet" type="text/css" href="/calendar/css/bootstrap-year-calendar.min.css">
	<style type="text/css">
		#calendar{
			width: 100%;
			height: 100%;
...
@section('after-scripts-end')
	...
	<script type="text/javascript" src="/calendar/bootstrap-3.3.5/js/bootstrap.min.js"></script>
	<script type="text/javascript" src="/calendar/js/bootstrap-datepicker.min.js"></script>
	<script type="text/javascript" src="/calendar/js/bootstrap-year-calendar.min.js"></script>
	<script type="text/javascript" src="/calendar/js/bootstrap-popover.js"></script>

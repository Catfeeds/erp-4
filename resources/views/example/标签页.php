...
@section('page-header')
    <h1>
        人员管理
        <small>人员信息</small>
        <a class="btn btn-success btn-xs " href="{{ URL('admin/luster/personnels/create') }}"><b>新 建</b></a>
    </h1>
@endsection

@section('breadcrumbs')
    @include('backend.luster.personnel.includes.breadcrumbs')
...
<div class="box box-success">
  <div class="box-body">
    <ul id="myTab" class="nav nav-tabs">
       <li class="active"><a href="#A" data-toggle="tab">员工</a></li>
       <li><a href="#B" data-toggle="tab">客户</a></li>
       <li><a href="#C" data-toggle="tab">所有人员</a></li>
    </ul>
